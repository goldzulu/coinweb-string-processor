...
import { getContractId } from 'string-reverser.cm';
...
When you run the predefined query below (with the correct `first key` set), you
should see your expected result stored in the response body.
