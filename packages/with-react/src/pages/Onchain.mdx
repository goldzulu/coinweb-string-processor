...
Traditionally the reactive smart contract is divided in the onchain and offchain
...
Let's take a look at the onchain part of the string-processor smart contract
...
The offchain code is the part of the smart contract that is not deployed on
