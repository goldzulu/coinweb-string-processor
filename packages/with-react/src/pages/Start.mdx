...
- We'll start by crafting a simple string reverser contract. You'll learn how to
  use the command-line interface (CLI) of the `@coinweb/cweb-tool` to invoke a
  pre-defined contract template in YAML format, which will handle the string
...
Let's get started on this adventure into the world of reactive smart contracts!
