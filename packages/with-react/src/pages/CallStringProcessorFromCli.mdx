...
At this point we have created a Coinweb reactive smart contract, wrote the
onchain.js code and deployed the contract. Now we can call the contract from the
