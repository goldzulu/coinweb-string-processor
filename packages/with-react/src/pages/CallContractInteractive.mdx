...
# Call the Smart Contract from a dApp

As of now we have created a contract, registered it via our CLI and also called it
...
## Call the Smart Contract with Provided Arguments
...
## Read your Claim from the Network
