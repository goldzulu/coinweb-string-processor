# Create a Coinweb Smart Contract

The _create_ step involves writing the code for the coinweb smart contract.
This includes defining the contract, its onchain and offchain code, and any
interfaces it shall provide. In this tutorial we will concentrate on Javascript
(Typescript) only. In order to create this tutorial dApp you can easily make use
of the `create coinweb-dapp` script. In-depth explanations can be found on
...
Alternatively you can clone the public repository directly:

```bash
git clone https://gitlab.com/coinweb/ccd-examples/string-processor-tutorial.git
```
...
All smart contracts are located in the `packages` directory under the
[`*.cm` naming convention](https://docs.coinweb.io/develop/getstarted/get-started-folder-structure#the-contract-module).
